...
import ProductAttributesInput, {
	type ProductAttribute,
} from "../components/products/ProductAttributesInput";
import ProductVariantTable, {
	type ProductVariant,
} from "../components/products/ProductVariantTable";
