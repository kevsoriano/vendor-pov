...
function AuthForm() {
	...
	return (
		<div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 w-[100vw] h-[calc(100vh-60px)] bg-gray-50">
			...
			<div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
							...
							<div className="flex items-center justify-between">
								<div className="flex gap-3">
									<div className="flex h-6 shrink-0 items-center">
                                      ...
                                      indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-2 
				...
				<p className="mt-10 text-center text-sm/6 text-gray-500">
					{isLogin && <span>Not a member? </span>}
					{!isLogin && <span>Already have an account? </span>}
					<Link
						to={`?mode=${isLogin ? "signup" : "login"}`}
						className="font-semibold text-indigo-600 hover:text-indigo-500"
					>
						{isLogin ? "Create an account now" : "Login now"}
					</Link>
				</p>
			</div>
		</div>
