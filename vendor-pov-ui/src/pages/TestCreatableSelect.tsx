...
import CreatableMultiSelect, { type CreatableMultiSelectOption } from '../components/common/CreatableMultiSelect'
        ...
        <div className="p-10 max-w-md mx-auto">
            ...
            <div className="mb-8">
                ...
                <div className="mt-2 p-4 bg-gray-100 rounded">
                    <p><strong>Selected Tags:</strong> {JSON.stringify(selectedTags)}</p>
                </div>
            </div>


            <div className="mt-8 p-4 bg-gray-100 rounded">
                <p className="mt-2"><strong>Available Options (Shared):</strong></p>
                <ul className="list-disc pl-5">
                    {options.map(o => <li key={o.id}>{o.name}</li>)}
                </ul>
            </div>
