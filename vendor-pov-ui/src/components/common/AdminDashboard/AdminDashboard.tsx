		...
		<div className="admin-dashboard">
			<header className="header">
				...
				<p className="subtitle">
					Configure AI prompts, see instructions and manage dynamic variables.
				</p>
				<div className="actions">
					<button type="button" onClick={addPrompt} className="btn-primary">
						+ Add Prompt
					</button>
				</div>
			</header>
			...
			<footer className="footer">
				<small>
					Tip: variables use the <code>{`{{name}}`}</code> syntax and will be highlighted in
					the preview.
				</small>
			</footer>
		</div>
